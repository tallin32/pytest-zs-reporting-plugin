# -*- coding: utf-8 -*-
#
# pytest-zs-reporting-plugin documentation build configuration file, created by
...
project = 'pytest-zs-reporting-plugin'
copyright = '2015, Chris Meredith'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', 'pytest-zs-reporting-plugin Documentation',
     [author], 1)
]
